        ...
        {[
          {
            ...
            body: 'Ludum (en adelante, "nosotros") es responsable del tratamiento de los datos personales que recoges al usar esta plataforma. Puedes contactarnos en info@ludumgames.es.',
          },
          {
